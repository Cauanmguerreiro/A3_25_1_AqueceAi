...
const linksList = [
  ...
  { title: 'Github do Cauan Guerreiro', caption: 'github.com/Cauanmguerreiro', icon: 'code', link: 'https://github.com/Cauanmguerreiro' },
  { title: 'Github do César Bugmaer', caption: 'github.com/Bugmaer', icon: 'code', link: 'https://github.com/Bugmaer' },
  { title: 'Github do Guilherme Serrano', caption: 'github.com/guiserranodev1', icon: 'code', link: 'https://github.com/guiserranodev1' },
  { title: 'Github do Pedro Paz', caption: 'github.com/pedropazs', icon: 'code', link: 'https://github.com/pedropazs' },
]
